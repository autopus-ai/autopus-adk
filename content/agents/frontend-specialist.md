...
`Constraints` 기본값은 auto-fix 최대 2회, 스크린샷 DPR 1x입니다. `Design Context`와 `UX Intelligence`는 UI 파일이 변경되고 안전한 소스가 있을 때만 주입되며, 없으면 직접 도출합니다.
...
Playwright 테스트 생성/치유 절차와 프로젝트 테스트 관례는 `.claude/skills/frontend-verify/SKILL.md`를 따릅니다.
